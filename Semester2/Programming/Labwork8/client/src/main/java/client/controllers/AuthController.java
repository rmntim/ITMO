...
public class AuthController {
  ...
  public void register() {
    ...
    } catch (APIException | ErrorResponseException | ClassCastException e) {
  ...
  private List<String> validatePassword(String password) {
    ...
    if (upChars == 0)
      errors.add(localizator.getKeyString("PasswordContainUp"));
    if (lowChars == 0)
      errors.add(localizator.getKeyString("PasswordContainLow"));
    if (digits == 0)
      errors.add(localizator.getKeyString("PasswordContainDigit"));
    if (special == 0)
      errors.add(localizator.getKeyString("PasswordContainSpecial"));
