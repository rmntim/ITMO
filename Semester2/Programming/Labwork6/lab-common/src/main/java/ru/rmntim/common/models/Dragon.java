...
public record Dragon(String name, Coordinates coordinates, ZonedDateTime creationDate, Long age,
    ...
    public Dragon(String name, Coordinates coordinates, Long age, Color color, DragonType type, DragonCharacter character, DragonHead head) {
        this(name, coordinates, ZonedDateTime.now(), age, color, type, character, head);
    }
