...
public class ExecutionContext {
    ...
    /**
     * {@code inFile} is used by {@link ru.rmntim.server.commands.ExecuteCommand} and {@link Interpreter}
     * to handle printing some user-facing messages, such as PS1
     */
    private final boolean inFile;
    /**
     * {@code cwd} is needed for {@link ru.rmntim.server.commands.ExecuteCommand}
